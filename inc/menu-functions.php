...
/*
function hetas_home_link($menuItems, $args)
{
...
add_filter( 'wp_nav_menu_items', 'hetas_home_link', 10, 2 );
*/
 ...
 */
function hetas_add_menu_parent_class( $items ) {
    $parents = array();
...
add_filter( 'wp_nav_menu_objects', 'hetas_add_menu_parent_class' );
 ...
 */
function hetas_special_nav_class( $classes, $item ) {
    return $classes;
}
add_filter( 'nav_menu_css_class' , 'hetas_special_nav_class' , 10, 2 );

...
module.exports = {
  // Project options.
  projectURL: 'https://stagehetas.test',
  ...
  // Translation options.
  textDomain: 'hetas_twenty_seventeen',
  // Your textdomain here.
  translationFile: 'hetas_twenty_seventeen.pot',
  // Name of the translation file.
  translationDestination: './languages',
  // Where to save the translation files.
  packageName: 'hetas_twenty_seventeen',
  // Package name.
  bugReport: 'https://AhmadAwais.com/contact/',
  // Where can users report bugs.
  lastTranslator: 'Elliott Richmond',
  // Last translator Email ID.
  team: 'Elliott Richmond',
  // Team's Email ID.

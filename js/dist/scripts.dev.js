...
(function ($) {
  ...
  requiredField(); // EO currently only applied on the fuel search needs to be refactored

  $("#menu-main-menu-1 .sub-menu").hide(); //$(".current-menu-item .sub-menu, .current-menu-ancestor .sub-menu").show();
  ...
  */
  ...
  var active = $(".tabedsearch").tabs("option", "active"); // setter
